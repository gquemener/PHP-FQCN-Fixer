...
class FilenameClassnameSpec extends ObjectBehavior
{
    ...
    function it_supports_psr0_with_non_underscored_namespace_prefix(File $file)
    {
    ...
    function it_does_not_support_psr0_with_underscored_namespace_prefix(File $file)
    {
        $file->psr()->willReturn('psr-0');
    ...
    function it_resolves_classname(File $file)
    {
        ...
        $this->resolve($file)->shouldReturn('App');
    }
}
